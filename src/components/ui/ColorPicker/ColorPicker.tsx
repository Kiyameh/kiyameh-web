...
export default function ColorPicker({ onChange, value }: ColorPickerProps) {
	const startColor = value ? new Color(value) : new Color("oklch(0.64 0.25 8/100)");
	...
	return (
		<div className={styles.container}>
			...
			{/* Hex Selector */}
			<HexSelector onChange={(color) => handleColorChange(new Color(color).to(mode))} color={color.toString()} />
