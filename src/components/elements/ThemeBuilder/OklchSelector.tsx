...
export default function OklchSelector({
	...
	return (
		<div className={styles.panel}>
			{/* Hue Slider */}
			<div>
				<label htmlFor={hueId}>Hue: {color.hue.toFixed(0)}°</label>
				<input
					id={hueId}
					type="range"
					min="0"
			...
			{/* Chroma Slider */}
			<div>
				<label htmlFor={chromaId}>Chroma: {color.chroma.toFixed(2)}</label>
				<input
					id={chromaId}
					type="range"
					min="0"
			...
			{/* Alpha Slider */}
			<div>
				<label htmlFor={alphaId}>Alpha: {color.alpha.toFixed(0)}%</label>
				<input
					id={alphaId}
					type="range"
					min="0"
