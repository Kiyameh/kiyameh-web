...
export default function RgbaSelector({
	...
	return (
		<div className={styles.panel}>
			{/* Red Slider */}
			<div>
				<label htmlFor={redId}>Red: {color.red}</label>
				<input
					id={redId}
					type="range"
					min="0"
					...
					value={color.red}
					onChange={(e) =>
						handleColorChange("red", parseInt(e.target.value, 10))
					}
			...
			{/* Green Slider */}
			<div>
				<label htmlFor={greenId}>Green: {color.green}</label>
				<input
					id={greenId}
					type="range"
					min="0"
					...
					value={color.green}
					onChange={(e) =>
						handleColorChange("green", parseInt(e.target.value, 10))
					}
					className={styles.slider}
					style={
						{
			...
			{/* Blue Slider */}
			<div>
				<label htmlFor={blueId}>Blue: {color.blue}</label>
				<input
					id={blueId}
					type="range"
					min="0"
					...
					value={color.blue}
					onChange={(e) =>
						handleColorChange("blue", parseInt(e.target.value, 10))
					}
					className={styles.slider}
					style={
						{
			...
			{/* Alpha Slider */}
			<div>
				<label htmlFor={alphaId}>Alpha: {color.alpha}%</label>
				<input
					id={alphaId}
					type="range"
					min="0"
					...
					value={color.alpha}
					onChange={(e) =>
						handleColorChange("alpha", parseInt(e.target.value, 10))
					}
					className={styles.slider}
					style={
						{
