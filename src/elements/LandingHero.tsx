...
const SUBTITLES: Record<Language, { a: string; b: string }[]> = {
	en: [
...
export default function Hero({ language = "es" }: { language: Language }) {
	const [subtitle, setSubtitle] = useState(SUBTITLES[language][0]);
		...
		>
			...
			>
				<path
					...
					fill="var(--content)"
				/>
				<circle cx="53" cy="37" r="8" fill="var(--accent)" />
			</svg>
			...
			{/* Subtitle */}
			<div className="big-paragraph" style={{ height: "120px" }}>
